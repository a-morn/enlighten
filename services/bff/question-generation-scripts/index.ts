...
promises.writeFile('src/generated-data/game-of-thrones.json', gotQuestionsJson, 'utf8');
promises.writeFile('src/generated-data/countries.json', countryQuestionsJson, 'utf8');